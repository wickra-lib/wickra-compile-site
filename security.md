...
- GitHub → the [wickra-compile repository](https://github.com/wickra-lib/wickra-compile)
...
Wickra Compile parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-compile/blob/main/SECURITY.md)
